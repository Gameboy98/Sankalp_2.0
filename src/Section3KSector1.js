...
export default class Section3KSector1 extends Component {
  ...
  async componentDidMount() {
    ...
    let sectorA1 =  await AsyncStorage.getItem("SelectedSectorB1");
    let sectorA2 =  await AsyncStorage.getItem("SelectedSectorB2");
    let sectorA3 =  await AsyncStorage.getItem("SelectedSectorB3");
    let sectorA4 =  await AsyncStorage.getItem("SelectedSectorB4");
    let sectorA5 =  await AsyncStorage.getItem("SelectedSectorB5");
  ...
  CheckTextInput = () => {
    if (this.state.populationTotalA == '' || this.state.populationFemaleA == '' || this.state.populationCasteA == ''|| this.state.populationTribeA == ''|| this.state.populationPwdA == '') {
      ...
      if(this.state.sector2=='' || this.state.sector2==null){
        ...
        this.props.navigation.navigate("Section3KSector2");
      }
    }
  ...
  CheckSector = () => {
    if (this.state.sectorA2==null ) {
      ...
      this.props.navigation.navigate("Section3JSector3");
    }else if(this.state.sectorA5==null) {
      this.props.navigation.navigate("Section3JSector4");
    }else {
      this.props.navigation.navigate("Section3JSector5");
    }
    ...
    return (
      ...
      <View>
        <View style={styles.question}>
          ...
          <View style= {styles.check1}>
            <Text   style={{marginTop: 40,marginBottom: 10, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 16 / 20 )</Text>
