...
export default class Section5I1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      resourcePosition: '',
  ...
  CheckTextInput = () => {
    if ( this.state.unitCost5A == -1 || this.state.unit == -1) {
      alert('Please Enter Fields');
        ...
        this.props.navigation.navigate("Section5I2");
          ...
          <View>
            <View style={styles.question}>
              <View style={styles.check1}>
                ...
                <Text style={styles.text21}>5 (I):   </Text>
                <Text style={styles.text1}>Engagement with industry and non-state actors</Text>
                </View>

                <TextInput placeholder="Total Cost (INR)" style={styles.textInput}  returnKeyType="done"
                  keyboardType="numeric" onChangeText={(text) => this.setState({unitCost5A: text}) }/>

                <View style={styles.check21}>
                <Text style={styles.text21}>5 (I1):   </Text>
                <Text style={styles.text1}>Pilots/Projects for apprenticeship promotion</Text>
                </View>

                <TextInput placeholder="Unit Cost (INR)" style={styles.textInput}  returnKeyType="done"
                  keyboardType="numeric" onChangeText={(text) => this.setState({unitCost5A: text}) }/>
                ...
                <Text   style={{marginTop: 30, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 7 / 11 )</Text>

                <View style= {styles.check1234}>
                <TouchableHighlight
                style={styles.back}
                onPress={() => this.props.navigation.navigate("Section5G")}
                underlayColor='#fff'>
