...
export default class Section5K extends Component {
  constructor(props) {
    super(props);
    this.state = {
      resourcePosition: '',
  ...
  CheckTextInput = () => {
    if (this.state.unitCost5A == -1 || this.state.unit == -1) {
      alert('Please Enter Fields');
        ...
        this.props.navigation.navigate("Section5M");
          ...
          <View>
            <View style={styles.question}>
              <View style={styles.check1}>
                ...
                <Text style={styles.text21}>5 (L):   </Text>
                <Text style={styles.text1}>Pilot projects to enhance participation of SC designated group</Text>
                </View>
                ...
                <Text   style={{marginTop: 30, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 10 / 11 )</Text>

                <View style= {styles.check1234}>
                <TouchableHighlight
                style={styles.back}
                onPress={() => this.props.navigation.navigate("Section5K")}
                underlayColor='#fff'>
