...
export default class Section3JSector3 extends Component {
    ...
    return (
      ...
      <View>
        <View style={styles.question}>
          ...
          <View style= {styles.check1}>
            <Text   style={{marginTop: 40,marginBottom: 10, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 13 / 20 )</Text>

            <View style= {styles.check1234}>
            <TouchableOpacity
            style={styles.back}
            onPress={() => this.props.navigation.navigate("Section3JSector2")}
            underlayColor='#fff'>
