...
export default class Section5N extends Component {
  constructor(props) {
    super(props);
    this.state = {
      resourcePosition: '',
          ...
          <View>
            <View style={styles.question}>
              <View style={styles.check1}>
                ...
                <Text style={styles.text21}>5 (N):   </Text>
                <Text style={styles.text1}>Pilot projects to enhance participation of Persons with Disabilities (PWDs)</Text>
                </View>
                ...
                <TouchableHighlight
                style={styles.back}
                onPress={() => this.props.navigation.navigate("Section5M")}
                underlayColor='#fff'>
