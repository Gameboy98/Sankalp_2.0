...
export default class Section5M extends Component {
  constructor(props) {
    super(props);
    this.state = {
      resourcePosition: '',
  ...
  CheckTextInput = () => {
    if (this.state.unitCost5A == -1 || this.state.unit == -1) {
      alert('Please Enter Fields');
        ...
        this.props.navigation.navigate("Section5N");
          ...
          <View>
            <View style={styles.question}>
              <View style={styles.check1}>
                ...
                <Text style={styles.text23}>Access and Completion of Skill Training for Women and other Disadvantaged Groups</Text>
                </View>
                <View style={styles.check1}>
                <View style={styles.check21}>
                <Text style={styles.text21}>5 (M):   </Text>
                <Text style={styles.text1}>Pilot projects to enhance participation of ST designated group</Text>
                </View>

                <TextInput placeholder="No. of Beneficiaries (Total)" style={styles.textInput}  returnKeyType="done"
                  keyboardType="numeric" onChangeText={(text) => this.setState({unitCost5A: text}) }/>

                <TextInput placeholder="No. of Beneficiaries (Youth)" style={styles.textInput}  returnKeyType="done"
                  keyboardType="numeric" onChangeText={(text) => this.setState({unit: text}) }/>
                <Text style={styles.text1}>    Total Cost (INR)</Text>
                <View style={styles.textBorder}>
                <Text style={[styles.submitText1]}>{result}</Text>
                </View>
                <Text   style={{marginTop: 30, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 11 / 11 )</Text>

                <View style= {styles.check1234}>
                <TouchableHighlight
                style={styles.back}
                onPress={() => this.props.navigation.navigate("Section5L")}
                underlayColor='#fff'>
