...
export default class Section3JSector2 extends Component {
  ...
  CheckTextInput = () => {
    if (this.state.populationTotalA == '' || this.state.populationFemaleA == '' || this.state.populationCasteA == ''|| this.state.populationTribeA == ''|| this.state.populationPwdA == '') {
      ...
      if(this.state.sector3=='' || this.state.sector3==null){
      ...
      <View>
        <View style={styles.question}>
          <View style={styles.check1}>
            ...
            <View style={styles.check21}>
            <Text style={styles.text21}>Sector 2:   </Text>
            <Text style={styles.text1}>{this.state.sector2}</Text>
            </View>
          ...
          <View style= {styles.check1}>
            <Text   style={{marginTop: 40,marginBottom: 10, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 12 / 20 )</Text>

            <View style= {styles.check1234}>
            <TouchableOpacity
            style={styles.back}
            onPress={() => this.props.navigation.navigate("Section3JSector1")}
            underlayColor='#fff'>
