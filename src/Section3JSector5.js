...
export default class Section3JSector5 extends Component {
      ...
      <View>
        <View style={styles.question}>
          <View style={styles.check1}>
            ...
            <View style={styles.check21}>
            <Text style={styles.text21}>Sector 5:   </Text>
            <Text style={styles.text1}>{this.state.sector5}</Text>
            </View>
          ...
          <View style= {styles.check1}>
            <Text   style={{marginTop: 40,marginBottom: 10, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 15 / 20 )</Text>

            <View style= {styles.check1234}>
            <TouchableOpacity
            style={styles.back}
            onPress={() => this.props.navigation.navigate("Section3JSector4")}
            underlayColor='#fff'>
