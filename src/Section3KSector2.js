...
export default class Section3KSector2 extends Component {
  ...
  CheckTextInput = () => {
    if (this.state.populationTotalA == '' || this.state.populationFemaleA == '' || this.state.populationCasteA == ''|| this.state.populationTribeA == ''|| this.state.populationPwdA == '') {
      ...
      if(this.state.sector3=='' || this.state.sector3==null){
        ...
        this.props.navigation.navigate("Section3KSector3");
      }
    }
      ...
      <View>
        <View style={styles.question}>
          ...
          <View style= {styles.check1}>
            ...
            <TouchableOpacity
            style={styles.back}
            onPress={() => this.props.navigation.navigate("Section3KSector1")}
            underlayColor='#fff'>
