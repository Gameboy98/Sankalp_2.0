...
export default class Section5C1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  CheckTextInput = () => {
    if (this.state.units == '' || this.state.costAnnum == '') {
      alert('Please Enter Fields');
    }else {
      var f1 = this.state.costAnnual;
        var f2 = this.state.units ;
          const result1 = f1 && f2 ?  f2 * f1 : null;
        this.setState({dataTotal:result1});
        this.props.navigation.navigate("Section5C2",{totalCost5C1:result1,});
    ...
    let url = "https://youth-apicalls.appspot.com/sankalp/add/demographic/data/section/five/";
      ...
      console.log("SomeLog",data);
       if(data.response.confirmation == 1){
           this.props.navigation.navigate("Section5C2");
        }else {
        alert("Somethin Went Wrong");
        }
  }
          ...
          <View>
            <View style={styles.question}>
              <View style={styles.check1}>
                ...
                <Text style={styles.text21}>5 (C1):   </Text>
                <Text style={styles.text1}>Hiring of resources for data analysis</Text>
                </View>
                ...
                <Text   style={{marginTop: 30, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 2 / 11 )</Text>
