...
export default class Section3C extends Component {
  ...
  async storeData() {
    try {
        await AsyncStorage.setItem("SelectedSectorB1",this.state.query1);
        await AsyncStorage.setItem("SelectedSectorB2",this.state.query2);
        await AsyncStorage.setItem("SelectedSectorB3",this.state.query3);
        await AsyncStorage.setItem("SelectedSectorB4",this.state.query4);
        await AsyncStorage.setItem("SelectedSectorB5",this.state.query5);
    } catch (error) {
  ...
  CheckTextInput = () => {
    if (this.state.query1 == '') {
      ...
      this.storeData();
      this.props.navigation.navigate("Section3D");
    }
      ...
      <KeyboardAvoidingView behavior="padding" enabled>
          <View>
            <View style={styles.question}>
              ...
              <Text style={styles.text21}>3 (C). </Text>
              <Text style={styles.text1}>Sector Skill Councils Representing Primary Sectors of Employment which account for bulk of <Text style={styles.BoldText}>migration within state</Text></Text>
              </View>
              </View>
              ...
              <View style= {styles.check1}>
                <Text   style={{marginTop: 140,marginBottom: 10, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 3 / 20 )</Text>

                <View style= {styles.check1234}>
                <TouchableOpacity
                style={styles.back}
                onPress={() => this.props.navigation.navigate("Section3B")}
                underlayColor='#fff'>
