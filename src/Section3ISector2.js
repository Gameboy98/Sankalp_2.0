...
export default class Section3ISector2 extends Component {
    ...
    return (
      ...
      <View>
        <View style={styles.question}>
          ...
          <View style= {styles.check1}>
            <Text   style={{marginTop: 40,marginBottom: 10, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 7 / 20 )</Text>

            <View style= {styles.check1234}>
            <TouchableOpacity
            style={styles.back}
            onPress={() => this.props.navigation.navigate("Section3I")}
            underlayColor='#fff'>
