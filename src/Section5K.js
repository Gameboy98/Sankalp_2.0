  ...
  CheckTextInput = () => {
    if ( this.state.unitCost5A == -1 || this.state.unit == -1) {
      alert('Please Enter Fields');
        ...
        this.props.navigation.navigate("Section5L");
          ...
          <View>
            <View style={styles.question}>
              <View style={styles.check1}>
                ...
                <Text style={styles.text21}>5 (K):   </Text>
                <Text style={styles.text1}>Pilot projects to enhance participation of women</Text>
                </View>
                ...
                <Text   style={{marginTop: 30, color: "#ffffff",fontSize:18,alignSelf: "center",}}>( 9 / 11 )</Text>

                <View style= {styles.check1234}>
                <TouchableHighlight
                style={styles.back}
                onPress={() => this.props.navigation.navigate("Section5I2")}
                underlayColor='#fff'>
